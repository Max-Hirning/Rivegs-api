# Rivegs API
Welcome to the Rivegs API, a backend service for a recipe app built using NestJS, MongoDB, and other technologies.
...
1. Copy code:
`git clone https://github.com/Max-Hirning/Rivegs-api.git`
